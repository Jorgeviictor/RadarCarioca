...
public final class DatabaseModule_ProvideAlertDaoFactory implements Factory<AlertDao> {
  ...
  public DatabaseModule_ProvideAlertDaoFactory(Provider<RadarDatabase> dbProvider) {
  ...
  public static DatabaseModule_ProvideAlertDaoFactory create(Provider<RadarDatabase> dbProvider) {
